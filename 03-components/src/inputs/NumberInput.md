...
|---|---|---|
| เลขที่ไม่ใช่ปริมาณ (เลขนิติบุคคล · โทรศัพท์) | `<TextInput inputMode="numeric">` | ไม่ควรคั่นหลักพัน ไม่ควรมีปุ่มเพิ่ม/ลด |
| ช่วงค่า | `<Slider>` | มีช่องกรอกในตัวอยู่แล้ว |
...
// ✅
<TextInput label="เลขทะเบียนนิติบุคคล" inputMode="numeric" />
```
...
| ❌ | ✅ | ทำไม |
|---|---|---|
| ใช้กับเลขนิติบุคคล/โทรศัพท์ | `<TextInput inputMode="numeric">` | คั่นหลักพันทำให้เลขผิด |
