...
| กำลังโหลด (Loading) | — | ไม่มีสถานะ "กำลังอัปโหลด" ในตัว **โดยเจตนา** — `isLoading` ของ Astryx อยู่**นอกขอบเขต parity** ตามคำตัดสิน 2026-07-28 ข้อ 1 (ขอบเขต = ชื่อ + prop สี่ตัวของ §8) · ความคืบหน้าประกอบที่ระดับหน้าด้วย [`<ProgressBar>`](../feedback/ProgressBar.md) ซึ่งมี `unknown` สำหรับงานที่ยังไม่รู้ระยะ · ปิดหนี้ 2.2 เมื่อ 2026-07-29 |
