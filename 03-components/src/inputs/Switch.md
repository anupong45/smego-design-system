...
|---|---|---|
| ค่าในฟอร์มที่รอกดบันทึก | `<Checkbox>` | switch สื่อว่ามีผลแล้ว |
| ยอมรับเงื่อนไข | `<Checkbox>` | เป็นค่าที่ส่งไปกับฟอร์ม |
| **ตัวกรอง** | `<Chip>` | ตัวกรองไม่ได้ "เปิด/ปิด" ระบบ |
| เลือกจาก 2 ตัวเลือกที่มีชื่อ | `<RadioGroup>` | เปิด/ปิด ≠ ก/ข |
...
| ❌ | ✅ | ทำไม |
|---|---|---|
| Switch ในฟอร์มที่มีปุ่มบันทึก | `<Checkbox>` | ผู้ใช้คิดว่ามีผลแล้ว |
| Switch เป็นตัวกรอง | `<Chip>` | ตัวกรองไม่ได้เปิด/ปิดระบบ |
...
| Switch สำหรับ ก/ข | `<RadioGroup>` | เปิด/ปิด ≠ สองตัวเลือกที่มีชื่อ |
