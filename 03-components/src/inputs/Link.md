...
ถ้าต้องการบอกว่า "เคยดูแล้ว" ให้ใช้ป้ายที่ชัดเจน (`<Badge>ดูแล้ว</Badge>`) ซึ่ง screen reader อ่านได้ด้วย
...
| `a:visited { color: purple }` | `<Badge>ดูแล้ว</Badge>` | สี visited ทำให้กริดสินค้าเลอะ และ screen reader ไม่ได้ยิน |
