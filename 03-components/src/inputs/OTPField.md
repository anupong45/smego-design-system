...
|---|---|---|
| รหัสยาวกว่า ~8 หลัก | `<TextField>` | กล่องแยกเกิน 8 อันสแกนด้วยตายาก |
| รหัสที่มีตัวอักษร | `<TextField>` | `inputMode="numeric"` จะเปิดแป้นผิด |
| รหัสผ่าน | `<TextField type="password">` | ต้องซ่อนค่าและให้ตัวจัดการรหัสผ่านกรอก |
