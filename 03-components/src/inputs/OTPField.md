...
| ประสิทธิภาพ (Performance) | ✅ | **แก้เป็น `min-h-12` แล้ว** (2026-07-29 · ปิดหนี้ 2.5) — ยังได้พื้น 48px เท่าเดิม แต่ยืดตามได้เมื่อผู้ใช้ตั้งขนาดตัวอักษรใหญ่ขึ้น ซึ่ง SC 1.4.4 ให้ทำได้ถึง 200% · ความกว้าง `w-11` คงไว้เพราะทั้ง 6 ช่องต้องเท่ากันจึงอ่านเป็นชุดเดียว |
