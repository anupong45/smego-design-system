...
| เลือกหลายค่า | `<CheckboxList>` หรือ `<Token>` | |
...
ต่างจาก `TextInput` ตรงที่ **ผลลัพธ์เห็นได้ทันที** — ผู้ใช้เห็นรายการกระพริบว่างเปล่ากลางทาง แล้วคิดว่าไม่มีข้อมูล จึงลบทิ้งพิมพ์ใหม่

⚠️ **แต่กัน `onInputChange` ทั้งหมดไม่ได้** เหมือน TextInput เพราะผู้ใช้ต้องเห็นสิ่งที่ตัวเองพิมพ์ในช่อง
...
| กัน `onChange` ทั้งหมดแบบ TextInput | กันเฉพาะการกรอง | ผู้ใช้ไม่เห็นสิ่งที่ตัวเองพิมพ์ |
