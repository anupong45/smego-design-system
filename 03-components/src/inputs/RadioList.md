...
| ตัวเลือกเกิน ~7 ข้อ | `<Select>` (Pass 2) | สแกนด้วยตายากและกินพื้นที่แนวตั้งมาก |
| เปิด/ปิดสองสถานะ | `<Switch>` (Pass 2) | radio 2 ตัวสำหรับ ใช่/ไม่ใช่ กินที่โดยไม่จำเป็น |
| ตัวกรอง | `<Chip>` | ตัวกรองต้องยกเลิกได้ — radio ยกเลิกไม่ได้ |
...
| radio 12 ตัว | `<Select>` | สแกนยากและกินที่ |
