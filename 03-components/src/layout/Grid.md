...
| ตารางข้อมูล | `<DataTable>` (Pass 5) | ตารางต้องมี `<th>` และ `scope` — grid ไม่มีความหมายเชิงตาราง |
...
**ต้องมี skip link** ไปที่เนื้อหาหลัก — เป็นเงื่อนไข ไม่ใช่ทางเลือก (SC 2.4.1) จะถูกจัดการที่ระดับ Template ในชั้น 05
