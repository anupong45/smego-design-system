...
> ⚠️ ถ้าเนื้อหาแต่ละหัวข้อ**ไม่ต้องเทียบกัน** และมีไม่เกิน ~5 หัวข้อ ให้พิจารณา [`<TabList>`](../navigation/TabList.md) แทน — `Collapsible` เหมาะกับเนื้อหาที่ผู้ใช้อยากเปิดหลายอันพร้อมกัน
