...
⚠️ ถ้าเปิดมาแล้วต้องมีรายการ **ติ๊กค้างไว้** นั่นคือ `Selector` หรือ [`CheckboxGroup`](../inputs/CheckboxInput.md) ไม่ใช่เมนู
...
|---|---|---|
| ใช้เก็บค่าที่ต้องติ๊กค้าง | `Selector` / `CheckboxGroup` | เมนูคือคำสั่ง ไม่ใช่ค่า (§1) |
