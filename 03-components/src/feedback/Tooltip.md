...
|---|---|---|
| **ข้อมูลจำเป็นต่อการตัดสินใจ** | ข้อความในหน้า หรือ `<Popover>` | ผู้ใช้ touch ไม่มี hover — เข้าไม่ถึงเลย |
| ชื่อของปุ่มไอคอน | `aria-label` ผ่าน `<IconButton label>` | tooltip ไม่ใช่ชื่อ accessible |
| ข้อความยาวกว่า 2 บรรทัด | `<Popover>` | อ่านไม่ทันก่อนเมาส์เลื่อนออก |
| มีลิงก์หรือปุ่มข้างใน | `<Popover>` | ผู้ใช้คีย์บอร์ดเข้าไปถึงไม่ได้ |
...
ถ้าข้อมูลจำเป็นต่อการตัดสินใจ ให้แสดงเป็น **ข้อความในหน้า** หรือใช้ **`<Popover>` ที่เปิดด้วยการกด**

### ★★ ห้ามใส่สิ่งที่กดได้ใน tooltip

ผู้ใช้คีย์บอร์ดเข้าไปถึงไม่ได้ เพราะ **tooltip หายเมื่อ focus ย้าย**

ถ้าต้องมีลิงก์ ให้ใช้ `<Popover>` ซึ่งเก็บ focus ไว้ได้
...
| `<Tooltip><Link>อ่านเพิ่ม</Link></Tooltip>` | `<Popover>` | tooltip หายเมื่อ focus ย้าย |
...
| tooltip ยาว 4 บรรทัด | `<Popover>` | อ่านไม่ทันก่อนเมาส์เลื่อนออก |
