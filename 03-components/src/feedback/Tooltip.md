...
| ตอบสนอง (Responsive) | ✅ | **วัดที่ 320px แล้ว** (2026-07-29 · ปิดหนี้ 2.1) — `e2e/tooltip-320.spec.ts`: กล่องกว้าง **256px** (`max-w-64`) วางที่ **12–268** · `scrollWidth 320 = clientWidth 320` ⇒ **ไม่ต้องแก้อะไร** ไม่ต้องจำกัดความกว้างเพิ่มและไม่ต้องจำกัดความยาวข้อความ · การวางตำแหน่งอัตโนมัติของ RAC เอาอยู่จริง |
