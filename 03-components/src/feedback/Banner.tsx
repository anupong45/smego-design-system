        ...
        {onDismiss && (
          ...
          <IconButton
            ...
            /* ★ size md = เป้า 36×36 ไม่ใช่ sm ที่ได้ 24×24 พอดีเกณฑ์ —
               ...
               ★ `-me-2 -mt-2` = **8px เท่ากับ `p-2` ของ IconButton md เป๊ะ**
               (ไอคอน 20 + p-2 = 36×36) ⇒ ขอบไอคอนตรงกับขอบเนื้อหาของกล่อง
               เดิมเป็น `-1.5` (6px) ซึ่งเป็นค่าประมาณ **และอยู่นอกสเกลที่อนุมัติ**
               — คำตัดสิน 2026-07-30: ห้ามค่านอกสเกล บังคับด้วย `lint:classes` */
