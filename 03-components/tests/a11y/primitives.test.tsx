...
import {
  ...
  TextInput, TextArea, Checkbox, CheckboxGroup, Radio, RadioGroup, RangeSlider,
...
const cases: [string, React.ReactElement][] = [
  ...
  [
    'Checkbox · aria-label เดี่ยว',
    <Checkbox aria-label="เลือกสินค้าทั้งหมดในหน้านี้" isIndeterminate />,
  ],
