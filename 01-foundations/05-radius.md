...
| Input · Select · Textarea | `md` 8 | ตรงกับปุ่ม เพื่อให้ฟอร์มดูเป็นชุดเดียว |
| Checkbox | `sm` 6 | เล็กกว่า input เพราะกล่องเล็กกว่า — ดูข้อ 3 |
| Radio | `full` | วงกลม เป็นข้อยกเว้นตามหลักสากล |
| Card สินค้า/บริการ | `lg` 12 | |
| Alert · Banner · Info tint | `lg` 12 | |
| Modal · Dialog | `xl` 16 | |
...
| Chip ตัวกรอง · Tag สถานะ | `full` | ข้อความสั้นเสมอ ไม่มีปัญหาความยาว |
